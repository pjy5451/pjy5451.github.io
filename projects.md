...
Selected projects from graduate research, independent experiments, and applied work. Each card links to a short detail page that can hold the project context, method, data, and outcomes.
...
<div class="project-grid">
    <a class="project-card" href="{{ '/projects/bridge-monitoring.html' | relative_url }}">
        ...
        <p>Low-power sensing, cloud data fusion, and reference-free displacement estimation for long-term bridge monitoring.</p>
