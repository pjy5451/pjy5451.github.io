...
<div class="project-grid">
    <a class="project-card" href="{{ '/projects/onboard-monitoring.html' | relative_url }}">
        ...
        <span class="project-tags"><span>OBM</span><span>Vehicle Sensing</span><span>FIR Filter</span></span>
    </a>
    ...
    <a class="project-card" href="{{ '/projects/weight-in-motion.html' | relative_url }}">
        ...
        <span class="project-tags"><span>YOLO</span><span>WIM</span><span>Data Pipeline</span></span>
    </a>
    ...
    <a class="project-card" href="{{ '/projects/concrete-crack-monitoring.html' | relative_url }}">
        ...
        <span class="project-tags"><span>Crack Sensing</span><span>Visualization</span><span>History</span></span>
    </a>
    ...
    <a class="project-card" href="{{ '/projects/bridge-monitoring.html' | relative_url }}">
        ...
        <span class="project-tags"><span>SHM</span><span>IoT Sensing</span><span>Displacement</span></span>
    </a>

    <a class="project-card" href="{{ '/projects/quay-wall-monitoring.html' | relative_url }}">
        <span class="project-year">2022 - 2024</span>
        <span class="project-type">AI Monitoring</span>
        ...
        <span class="project-tags"><span>AI</span><span>Port Structures</span><span>Monitoring</span></span>
    </a>
