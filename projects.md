...
<div class="project-grid">
    ...
    <a class="project-card" href="{{ '/projects/quay-wall-monitoring.html' | relative_url }}">
        ...
        <img class="project-thumb" src="{{ '/assets/images/projects/quay-wall-monitoring.svg' | relative_url }}" alt="Quay wall monitoring project preview" />
    ...
    <a class="project-card" href="{{ '/projects/qr-lifecycle-monitoring.html' | relative_url }}">
        ...
        <img class="project-thumb" src="{{ '/assets/images/projects/qr-lifecycle.svg' | relative_url }}" alt="QR lifecycle monitoring project preview" />
