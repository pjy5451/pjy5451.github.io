...
<div class="bio-layout">
    <aside class="bio-sidebar">
        ...
        <p>UDNS Researcher. 현장 센싱 시스템, 구조물 모니터링, 데이터 기반 인프라 기술을 연구하고 개발합니다.</p>
        <div class="bio-links">
    ...
    <div class="bio-main">
        <section class="research-statement">
            <p>저는 인프라 구조물에서 계측된 데이터를 실제 엔지니어링 판단에 활용할 수 있는 근거로 바꾸는 현장 센싱 시스템을 개발합니다. IoT 센서, 임베디드 하드웨어, 클라우드 기반 데이터 파이프라인, 현장 실험, AI 기반 분석을 연결해 교량과 토목 인프라의 상태를 해석하는 연구를 수행하고 있습니다.</p>
